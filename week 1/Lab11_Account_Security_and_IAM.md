...
All screenshots used as evidence in this report are stored in the GitHub repository.

| Evidence File | Purpose |
|---|---|
| `1.0_LocalStack_Environment_Setup.png` | Verification of LocalStack Docker container and health status |
| `1.1_AWS_CLI_Verification.png` | Verification of AWS CLI connection to LocalStack |
| `2.1_create_admins_group.png` | Creation of the `Admins` IAM group |
| `2.2_attach_admin_policy.png` | Attachment of `AdministratorAccess` policy to `Admins` group |
| `2.3_create_admin_user.png` | Creation of `CloudAdmin_MELON` administrator account |
| `2.4_add_user_to_group.png` | Adding administrator user to `Admins` group |
| `2.5_verify_group_membership.png` | Verification of `Admins` group membership |
| `3.1_create_analyst_user.png` | Creation of `Analyst_MANGO` account |
| `3.2_attach_s3_readonly_policy.png` | Attachment of `AmazonS3ReadOnlyAccess` policy |
| `3.3_verify_attached_policy.png` | Verification of attached user policies |
| `4.1_create_access_key.png` | Creation of access key for analyst account |
| `4.2_list_access_keys.png` | Listing of analyst account access keys |
| `4.3_deactivate_access_key.png` | Deactivation of analyst account access key |
| `5.0_kubernetes_cluster_setup.png` | Creation and verification of Kubernetes cluster |
| `5.1_create_namespaces.png` | Creation of `dev` and `prod` namespaces |
| `6.1_create_service_account.png` | Creation of Kubernetes service account |
| `6.2_create_role.png` | Creation of Kubernetes Role |
| `6.3_create_rolebinding.png` | Creation of Kubernetes RoleBinding |
| `7.0_verify_rbac_permissions.png` | Verification of Kubernetes RBAC permissions |
| `verify_rolebinding_configuration.png` | Verification of RoleBinding configuration in YAML format |
| `cleanup_teardown.png` | Cleanup and teardown of lab environments |
